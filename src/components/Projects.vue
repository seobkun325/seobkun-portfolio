...
const projects = ref([
  {
    ...
    role: [
      "Vue.js 기반의 프론트엔드 UI 개발 및 상태 관리 최적화",
      "게임형 UX 설계를 도입하여 키보드 이벤트를 활용한 인터랙션 구현",
      "미디어 파일(이미지, 비디오, 오디오) 업로드 및 처리 기능 개발",
      "WebSocket을 활용하여 실시간 캡슐 공유 및 업데이트 기능 구현",
      "GitHub PR 리뷰 및 코드 관리, Jira를 활용한 협업 경험",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "반응형 UI 최적화 (맥북, 아이패드, 데스크탑 등 다양한 해상도 지원)",
    ],
    role: [
